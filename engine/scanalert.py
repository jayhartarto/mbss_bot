...
# BSJP v2 (Stage-1/Stage-2/rocket system) lives in engine/bsjp2.py -- the
# old Fase1/Fase2/pyramid code that used to be here was retired 2026-09-20,
# see archive/bsjp_legacy_fase1_fase2_pyramid_2026_09_20.py and memory
# project_bsjp_derisk_revisit_2026_09_17.md for why.
...
def _collect_active_monitor_tickers() -> list[str]:
    ...
    # BSJP pyramid's contribution here was retired 2026-09-20 along with the
    # rest of the old Fase1/Fase2/pyramid system (see
    # archive/bsjp_legacy_fase1_fase2_pyramid_2026_09_20.py). If BSJP v2's
    # intraday tracking (engine/bsjp2.py) later needs shared 1m bars too,
    # add its active-ticker union back in here the same way.
